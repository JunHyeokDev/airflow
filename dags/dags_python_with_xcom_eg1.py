...
with DAG (
    ...
    def pull_xcom(**kwargs):
        ti = kwargs['ti']
        value1 = ti.xcom_pull(key = 'key1',task_ids='push_xcom_task1')
        value2 = ti.xcom_pull(key = 'key2',task_ids='push_xcom_task1')
        value3 = ti.xcom_pull(key = 'key3',task_ids='push_xcom_task2')
